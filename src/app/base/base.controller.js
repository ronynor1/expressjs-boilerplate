...
class BaseController {
  ...
  // find all
  async clientFindAll(req, res, next) {

    try {

      const lang = header_language.match(req);
      const results = await BaseService.clientFindAll(this, req.query, lang);
  ...
  async clientFind (req, res, next) {
    ...
    try {
      ...
      const result = await BaseService.clientFind(this, id, lang);
